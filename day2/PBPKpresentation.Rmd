...
1. Use `models/simplePBPK.cpp` file to build a simple PBPK model.
...
1. Explore and compile typical adult male PBPK model `models/voriPBPK.cpp` 

```{r}

modA <- mread("models/voriPBPK")
...
dat <- read.csv("../data/source/tissue_comp_PT.csv")
...
modA <- mread("models/voriPBPK_ext") %>%
  param(MPPGI = 30.3/30) %>%
  param(Kp)
...
mod_mab <- mread("models/mAb_bamlanivimab.cpp")
