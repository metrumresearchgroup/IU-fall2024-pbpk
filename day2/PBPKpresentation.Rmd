...
Use the bamlanivimab mAb model as a template to add a simple tumor compartment. Run a simulation and plot mAb tumor concentration-time profile for 28 days. Tumor-specific parameters were obtained from Shah and Betts, 2012 publication (https://pubmed.ncbi.nlm.nih.gov/22143261/) 
...
Similarly, equations for antibody binding to specific tumor surface antigens and internalization of the complex can be added.
