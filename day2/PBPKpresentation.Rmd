...
- Use original mAb model as template. You can copy all code related to a different non-clearing tissue (eg: muscle) and replace tissue reference with tumor. This should take care of most what you need to do including updating ODEs, initial conditions, compartments, etc..
