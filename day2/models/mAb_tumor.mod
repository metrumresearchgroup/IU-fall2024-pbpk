...
// Other Blood Flow
PLQ_Lung = 181.9130000000000109 + (12.7*0.02) // [L/h]
...
// Tumor Volumes
V_Tumor = 0.02 // [L] Total Volume
V_Tumor_IS = 0.55*0.02  // [L] Interstitial Volume
V_Tumor_V = 0.07*0.02 // [L] Vascular Volume
PLQ_Tumor = 12.7*0.02 // [L/h] blood flow rate
Endothelial_Cell_Frac_Tumor = 0.005
SV_Tumor = 0.842
SIS_Tumor = 0.2
[ MAIN ]
...
double FcRn_Conc = FcRn_Availability*total_FcRn_in_nmole*1.0e-3/(V_endosomal_Lung+V_endosomal_Liver+V_endosomal_Heart+V_endosomal_Muscle+V_endosomal_Skin+V_endosomal_Adipose+V_endosomal_Bone+V_endosomal_Brain+V_endosomal_Kidney+V_endosomal_SI+V_endosomal_LI+V_endosomal_Pancreas+V_endosomal_Thymus+V_endosomal_Spleen+V_endosomal_Other+V_endosomal_Tumor);
...
double LF_Tumor = PLQ_Tumor*0.002; // [L/h]
double V_Tumor_bVM_Mem = V_Tumor_VM;
double V_Tumor_bIM_Mem = V_Tumor_VM;
double Organ_Endothelial_Cell_Tumor = 
  Total_Endothelial_Cell * Endothelial_Cell_Frac_Tumor*Scale_Factor;
double V_endosomal_Tumor = CL_Up_in_nL_per_hour_per_million_cells*pino_time*Organ_Endothelial_Cell_Tumor*1.0E-6*1.0E-9;

double V_Tumor_E7 = V_endosomal_Tumor*E7_vol_pct;
double V_Tumor_E6a = V_endosomal_Tumor*E6a_vol_pct;
double V_Tumor_E7b = V_endosomal_Tumor*E7b_vol_pct;
double CLup_VTumor =  CL_Up_in_nL_per_hour_per_million_cells*Organ_Endothelial_Cell_Tumor*1.0E-15;
double V_Tumor_VM = CLup_VTumor*tau_VM;
double V_Tumor_IM = CLup_VTumor*tau_IM;
double V_Tumor_bE7 = V_endosomal_Tumor*E7_vol_pct;
double V_Tumor_bE6a = V_endosomal_Tumor*E6a_vol_pct;
double V_Tumor_bE7b = V_endosomal_Tumor*E7b_vol_pct;
double V_Tumor_bVM = CLup_VTumor*tau_VM;
double V_Tumor_bIM = CLup_VTumor*tau_IM;
double V_Tumor_b2E7 = V_endosomal_Tumor*E7_vol_pct;
double V_Tumor_b2E6a = V_endosomal_Tumor*E6a_vol_pct;
double V_Tumor_b2E7b = V_endosomal_Tumor*E7b_vol_pct;
double V_Tumor_b2VM = CLup_VTumor*tau_VM;
double V_Tumor_b2IM = CLup_VTumor*tau_IM;
double CLup_Tumor = CLup_VTumor;
Cedg_Tumor_V_0 = 0.0000000000010000; // [um]
Cedg_Tumor_VM_0 = 0.0000000000010000; // [um]
Cedg_Tumor_E7_0 = 0.0000000000010000; // [um]
Cedg_Tumor_E6a_0 = 0.0000000000010000; // [um]
Cedg_Tumor_E7b_0 = 0.0000000000010000; // [um]
Cedg_Tumor_IM_0 = 0.0000000000010000; // [um]
Cedg_Tumor_IS_0 = 0.0000000000010000; // [um]
Cedg_Tumor_bVM_0 = 0.0000000000010000; // [um]
Cedg_Tumor_bE7_0 = 0.0000000000010000; // [um]
Cedg_Tumor_bE6a_0 = 0.0000000000010000; // [um]
Cedg_Tumor_bE7b_0 = 0.0000000000010000; // [um]
Cedg_Tumor_bIM_0 = 0.0000000000010000; // [um]
Cedg_Tumor_b2VM_0 = 0.0000000000010000; // [um]
Cedg_Tumor_b2E7_0 = 0.0000000000010000; // [um]
Cedg_Tumor_b2E6a_0 = 0.0000000000010000; // [um]
Cedg_Tumor_b2E7b_0 = 0.0000000000010000; // [um]
Cedg_Tumor_b2IM_0 = 0.0000000000010000; // [um]
Cexg_Tumor_V_0 = 0.0000000000000000; // [um]
Cexg_Tumor_VM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_E7_0 = 0.0000000000000000; // [um]
Cexg_Tumor_E6a_0 = 0.0000000000000000; // [um]
Cexg_Tumor_E7b_0 = 0.0000000000000000; // [um]
Cexg_Tumor_IM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_IS_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bVM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bE7_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bE6a_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bE7b_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bIM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_b2VM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_b2E7_0 = 0.0000000000000000; // [um]
Cexg_Tumor_b2E6a_0 = 0.0000000000000000; // [um]
Cexg_Tumor_b2E7b_0 = 0.0000000000000000; // [um]
Cexg_Tumor_b2IM_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bVM_Mem_0 = 0.0000000000000000; // [um]
Cexg_Tumor_bIM_Mem_0 = 0.0000000000000000; // [um]
CFcRn_Tumor_E6a_0 = FcRn_Conc;
CFcRn_Tumor_E7_0 = FcRn_Conc;
CFcRn_Tumor_E7b_0 = FcRn_Conc;
CFcRn_Tumor_VM_0 = FcRn_Conc*1e-4;
CFcRn_Tumor_IM_0 = FcRn_Conc*1e-4;
[ CMT ]
...
- L_LymphNode*Cedg_LN + (1.0 - SIS_Tumor)*LF_Tumor*Cedg_Tumor_IS)/V_LN;
...
- L_LymphNode*Cexg_LN + (1.0 - SIS_Tumor)*LF_Tumor*Cexg_Tumor_IS)/V_LN;
...
+ L_LymphNode*Cexg_LN + (PLQ_Tumor - LF_Tumor)*Cexg_Tumor_V);
dxdt_Cedg_Plasma = 0;
double EXG_ugml_Readout = Cexg_Plasma * MW_EDG/1000;
dxdt_Cexg_Tumor_V = (PLQ_Tumor*Cexg_Lung_V
                      - (PLQ_Tumor - LF_Tumor)*Cexg_Tumor_V
                      - (1.0-SV_Tumor)*LF_Tumor*Cexg_Tumor_V
                      - CLup_Tumor*FR*Cexg_Tumor_V
                      + CLup_Tumor*FR*Cexg_Tumor_VM)/V_Tumor_V;
dxdt_Cedg_Tumor_V = (PLQ_Tumor*Cedg_Lung_V
                      - (PLQ_Tumor - LF_Tumor)*Cedg_Tumor_V
                      - (1.0-SV_Tumor)*LF_Tumor*Cedg_Tumor_V
                      - CLup_Tumor*FR*Cedg_Tumor_V
                      + CLup_Tumor*FR*Cedg_Tumor_VM)/V_Tumor_V;
dxdt_Cexg_Tumor_VM = (CLup_Tumor*FR*Cexg_Tumor_V
                       - CLup_Tumor*FR*Cexg_Tumor_VM
                       - CLup_Tumor*FR*Cexg_Tumor_VM
                       + CLup_Tumor*FR*Cexg_Tumor_E7b
                       - k_on_7_EXG*Cexg_Tumor_VM*CFcRn_Tumor_VM*V_Tumor_VM
                       + k_off_7_EXG*Cexg_Tumor_bVM*V_Tumor_VM
                       - k_on_PS*Cexg_Tumor_VM*C_mem*V_Tumor_VM
                       + k_off_PS*Cexg_Tumor_bVM_Mem*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cexg_Tumor_bVM_Mem = (k_on_PS*Cexg_Tumor_VM*C_mem*V_Tumor_VM
                            - k_off_PS*Cexg_Tumor_bVM_Mem*V_Tumor_VM
                            - kint_PS*Cexg_Tumor_bVM_Mem*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cexg_Tumor_E7 = (CLup_Tumor*FR*Cexg_Tumor_VM
                       + CLup_Tumor*(1.0-FR)*Cexg_Tumor_IM
                       - CLup_Tumor*Cexg_Tumor_E7
                       - k_on_7_EXG*Cexg_Tumor_E7*CFcRn_Tumor_E7*V_Tumor_E7
                       + k_off_7_EXG*Cexg_Tumor_bE7*V_Tumor_E7
                       + kint_PS*Cexg_Tumor_bVM_Mem*V_Tumor_VM
                       + kint_PS*Cexg_Tumor_bIM_Mem*V_Tumor_IM)/V_Tumor_E7;
dxdt_Cexg_Tumor_E6a = (CLup_Tumor*Cexg_Tumor_E7
                        - CLup_Tumor*Cexg_Tumor_E6a
                        - k_on_6_EXG*Cexg_Tumor_E6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                        + k_off_6_EXG*Cexg_Tumor_bE6a*V_Tumor_E6a)/V_Tumor_E6a;
dxdt_Cexg_Tumor_E7b = (CLup_Tumor*(1.0-Prob_deg)*Cexg_Tumor_E6a
                        - CLup_Tumor*Cexg_Tumor_E7b
                        - k_on_7_EXG*Cexg_Tumor_E7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                        + k_off_7_EXG*Cexg_Tumor_bE7b*V_Tumor_E7b)/V_Tumor_E7b;
dxdt_Cexg_Tumor_IM = (CLup_Tumor*(1.0-FR)*Cexg_Tumor_IS
                       - CLup_Tumor*(1.0-FR)*Cexg_Tumor_IM
                       + CLup_Tumor*(1.0-FR)*Cexg_Tumor_E7b
                       - CLup_Tumor*(1.0-FR)*Cexg_Tumor_IM
                       - k_on_7_EXG*Cexg_Tumor_IM*CFcRn_Tumor_IM*V_Tumor_IM
                       + k_off_7_EXG*Cexg_Tumor_bIM*V_Tumor_IM
                       - k_on_PS*Cexg_Tumor_IM*C_mem*V_Tumor_IM
                       + k_off_PS*Cexg_Tumor_bIM_Mem*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cexg_Tumor_bIM_Mem = (k_on_PS*Cexg_Tumor_IM*C_mem*V_Tumor_IM
                            - k_off_PS*Cexg_Tumor_bIM_Mem*V_Tumor_IM
                            - kint_PS*Cexg_Tumor_bIM_Mem*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cexg_Tumor_IS = ((1.0-SV_Tumor)*LF_Tumor*Cexg_Tumor_V
                       - CLup_Tumor*(1.0-FR)*Cexg_Tumor_IS
                       + CLup_Tumor*(1.0-FR)*Cexg_Tumor_IM
                       - (1.0-SIS_Tumor)*LF_Tumor*Cexg_Tumor_IS)/V_Tumor_IS;
dxdt_Cexg_Tumor_bVM = (k_on_7_EXG*Cexg_Tumor_VM*CFcRn_Tumor_VM*V_Tumor_VM
                        - k_off_7_EXG*Cexg_Tumor_bVM*V_Tumor_VM
                        - k_on_7_EXG2*Cexg_Tumor_bVM*CFcRn_Tumor_VM*V_Tumor_VM
                        + k_off_7_EXG2*Cexg_Tumor_b2VM*V_Tumor_VM
                        - CLup_Tumor*FR*Cexg_Tumor_bVM
                        + CLup_Tumor*FR*Cexg_Tumor_bE7b
                        - kdeg_FcRn_Ab*Cexg_Tumor_bVM*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cexg_Tumor_b2VM = (k_on_7_EXG2 * Cexg_Tumor_bVM*CFcRn_Tumor_VM*V_Tumor_VM
                         - k_off_7_EXG2 * Cexg_Tumor_b2VM*V_Tumor_VM
                         - CLup_Tumor*FR*Cexg_Tumor_b2VM
                         + CLup_Tumor*FR*Cexg_Tumor_b2E7b
                         - kdeg_FcRn_Ab*Cexg_Tumor_b2VM*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cexg_Tumor_bE7 = (k_on_7_EXG*Cexg_Tumor_E7*CFcRn_Tumor_E7*V_Tumor_E7
                        - k_off_7_EXG*Cexg_Tumor_bE7*V_Tumor_E7
                        - k_on_7_EXG2*Cexg_Tumor_bE7*CFcRn_Tumor_E7*V_Tumor_E7
                        + k_off_7_EXG2*Cexg_Tumor_b2E7*V_Tumor_E7
                        - CLup_Tumor*Cexg_Tumor_bE7
                        + CLup_Tumor*FR*Cexg_Tumor_bVM
                        + CLup_Tumor*(1.0-FR)*Cexg_Tumor_bIM)/V_Tumor_E7;
dxdt_Cexg_Tumor_b2E7 = (k_on_7_EXG2 * Cexg_Tumor_bE7*CFcRn_Tumor_E7*V_Tumor_E7
                         - k_off_7_EXG2 * Cexg_Tumor_b2E7*V_Tumor_E7
                         - CLup_Tumor*Cexg_Tumor_b2E7
                         + CLup_Tumor*FR*Cexg_Tumor_b2VM
                         + CLup_Tumor*(1.0-FR)*Cexg_Tumor_b2IM)/V_Tumor_E7;
dxdt_Cexg_Tumor_bE6a = (k_on_6_EXG*Cexg_Tumor_E6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                         - k_off_6_EXG*Cexg_Tumor_bE6a*V_Tumor_E6a
                         - k_on_6_EXG2*Cexg_Tumor_bE6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                         + k_off_6_EXG2*Cexg_Tumor_b2E6a*V_Tumor_E6a
                         + CLup_Tumor*Cexg_Tumor_bE7
                         - CLup_Tumor*Cexg_Tumor_bE6a)/V_Tumor_E6a;
dxdt_Cexg_Tumor_b2E6a = (k_on_6_EXG2*Cexg_Tumor_bE6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                          - k_off_6_EXG2*Cexg_Tumor_b2E6a*V_Tumor_E6a
                          + CLup_Tumor*Cexg_Tumor_b2E7
                          - CLup_Tumor*Cexg_Tumor_b2E6a)/V_Tumor_E6a;
dxdt_Cexg_Tumor_bE7b = (k_on_7_EXG*Cexg_Tumor_E7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                         - k_off_7_EXG*Cexg_Tumor_bE7b*V_Tumor_E7b
                         - k_on_7_EXG2*Cexg_Tumor_bE7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                         + k_off_7_EXG2*Cexg_Tumor_b2E7b*V_Tumor_E7b
                         + CLup_Tumor*Cexg_Tumor_bE6a
                         - CLup_Tumor*Cexg_Tumor_bE7b)/V_Tumor_E7b;
dxdt_Cexg_Tumor_b2E7b = (k_on_7_EXG2*Cexg_Tumor_bE7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                          - k_off_7_EXG2*Cexg_Tumor_b2E7b*V_Tumor_E7b
                          + CLup_Tumor*Cexg_Tumor_b2E6a
                          - CLup_Tumor*Cexg_Tumor_b2E7b)/V_Tumor_E7b;
dxdt_Cexg_Tumor_bIM = (k_on_7_EXG*Cexg_Tumor_IM*CFcRn_Tumor_IM*V_Tumor_IM
                        - k_off_7_EXG*Cexg_Tumor_bIM*V_Tumor_IM
                        - k_on_7_EXG2*Cexg_Tumor_bIM*CFcRn_Tumor_IM*V_Tumor_IM
                        + k_off_7_EXG2*Cexg_Tumor_b2IM*V_Tumor_IM
                        + CLup_Tumor*(1.0-FR)*Cexg_Tumor_bE7b
                        - CLup_Tumor*(1.0-FR)*Cexg_Tumor_bIM
                        - kdeg_FcRn_Ab*Cexg_Tumor_bIM*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cexg_Tumor_b2IM = (k_on_7_EXG2*Cexg_Tumor_bIM*CFcRn_Tumor_IM*V_Tumor_IM
                         - k_off_7_EXG2*Cexg_Tumor_b2IM*V_Tumor_IM
                         + CLup_Tumor*(1.0-FR)*Cexg_Tumor_b2E7b
                         - CLup_Tumor*(1.0-FR)*Cexg_Tumor_b2IM
                         - kdeg_FcRn_Ab*Cexg_Tumor_b2IM*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cedg_Tumor_VM = (CLup_Tumor*FR*Cedg_Tumor_V
                       - CLup_Tumor*FR*Cedg_Tumor_VM
                       - CLup_Tumor*FR*Cedg_Tumor_VM
                       + CLup_Tumor*FR*Cedg_Tumor_E7b
                       - k_on_7_EXG*Cedg_Tumor_VM*CFcRn_Tumor_VM*V_Tumor_VM
                       + k_off_7_EXG*Cedg_Tumor_bVM*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cedg_Tumor_E7 = (CLup_Tumor*FR*Cedg_Tumor_VM
                       + CLup_Tumor*(1.0-FR)*Cedg_Tumor_IM
                       - CLup_Tumor*Cedg_Tumor_E7
                       - k_on_7_EXG*Cedg_Tumor_E7*CFcRn_Tumor_E7*V_Tumor_E7
                       + k_off_7_EXG*Cedg_Tumor_bE7*V_Tumor_E7)/V_Tumor_E7;
dxdt_Cedg_Tumor_E6a = (CLup_Tumor*Cedg_Tumor_E7
                        - CLup_Tumor*Cedg_Tumor_E6a
                        - k_on_6_EXG*Cedg_Tumor_E6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                        + k_off_6_EXG*Cedg_Tumor_bE6a*V_Tumor_E6a)/V_Tumor_E6a;
dxdt_Cedg_Tumor_E7b = (CLup_Tumor*(1.0-Prob_deg)*Cedg_Tumor_E6a
                        - CLup_Tumor*Cedg_Tumor_E7b
                        - k_on_7_EXG*Cedg_Tumor_E7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                        + k_off_7_EXG*Cedg_Tumor_bE7b*V_Tumor_E7b)/V_Tumor_E7b;
dxdt_Cedg_Tumor_IM = (CLup_Tumor*(1.0-FR)*Cedg_Tumor_IS
                       - CLup_Tumor*(1.0-FR)*Cedg_Tumor_IM
                       + CLup_Tumor*(1.0-FR)*Cedg_Tumor_E7b
                       - CLup_Tumor*(1.0-FR)*Cedg_Tumor_IM
                       - k_on_7_EXG*Cedg_Tumor_IM*CFcRn_Tumor_IM*V_Tumor_IM
                       + k_off_7_EXG*Cedg_Tumor_bIM*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cedg_Tumor_IS = ((1.0-SV_Tumor)*LF_Tumor*Cedg_Tumor_V
                       - CLup_Tumor*(1.0-FR)*Cedg_Tumor_IS
                       + CLup_Tumor*(1.0-FR)*Cedg_Tumor_IM
                       - (1.0-SIS_Tumor)*LF_Tumor*Cedg_Tumor_IS)/V_Tumor_IS;
dxdt_Cedg_Tumor_bVM = (k_on_7_EXG*Cedg_Tumor_VM*CFcRn_Tumor_VM*V_Tumor_VM
                        - k_off_7_EXG*Cedg_Tumor_bVM*V_Tumor_VM
                        - k_on_7_EXG2*Cedg_Tumor_bVM*CFcRn_Tumor_VM*V_Tumor_VM
                        + k_off_7_EXG2*Cedg_Tumor_b2VM*V_Tumor_VM
                        - CLup_Tumor*FR*Cedg_Tumor_bVM
                        + CLup_Tumor*FR*Cedg_Tumor_bE7b
                        - kdeg_FcRn_Ab*Cedg_Tumor_bVM*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cedg_Tumor_b2VM = (k_on_7_EXG2 * Cedg_Tumor_bVM*CFcRn_Tumor_VM*V_Tumor_VM
                         - k_off_7_EXG2 * Cedg_Tumor_b2VM*V_Tumor_VM
                         - CLup_Tumor*FR*Cedg_Tumor_b2VM
                         + CLup_Tumor*FR*Cedg_Tumor_b2E7b
                         - kdeg_FcRn_Ab*Cedg_Tumor_b2VM*V_Tumor_VM)/V_Tumor_VM;
dxdt_Cedg_Tumor_bE7 = (k_on_7_EXG*Cedg_Tumor_E7*CFcRn_Tumor_E7*V_Tumor_E7
                        - k_off_7_EXG*Cedg_Tumor_bE7*V_Tumor_E7
                        - k_on_7_EXG2*Cedg_Tumor_bE7*CFcRn_Tumor_E7*V_Tumor_E7
                        + k_off_7_EXG2*Cedg_Tumor_b2E7*V_Tumor_E7
                        - CLup_Tumor*Cedg_Tumor_bE7
                        + CLup_Tumor*FR*Cedg_Tumor_bVM
                        + CLup_Tumor*(1.0-FR)*Cedg_Tumor_bIM)/V_Tumor_E7;
dxdt_Cedg_Tumor_b2E7 = (k_on_7_EXG2 * Cedg_Tumor_bE7*CFcRn_Tumor_E7*V_Tumor_E7
                         - k_off_7_EXG2 * Cedg_Tumor_b2E7*V_Tumor_E7
                         - CLup_Tumor*Cedg_Tumor_b2E7
                         + CLup_Tumor*FR*Cedg_Tumor_b2VM
                         + CLup_Tumor*(1.0-FR)*Cedg_Tumor_b2IM)/V_Tumor_E7;
dxdt_Cedg_Tumor_bE6a = (k_on_6_EXG*Cedg_Tumor_E6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                         - k_off_6_EXG*Cedg_Tumor_bE6a*V_Tumor_E6a
                         - k_on_6_EXG2*Cedg_Tumor_bE6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                         + k_off_6_EXG2*Cedg_Tumor_b2E6a*V_Tumor_E6a
                         + CLup_Tumor*Cedg_Tumor_bE7
                         - CLup_Tumor*Cedg_Tumor_bE6a)/V_Tumor_E6a;
dxdt_Cedg_Tumor_b2E6a = (k_on_6_EXG2*Cedg_Tumor_bE6a*CFcRn_Tumor_E6a*V_Tumor_E6a
                          - k_off_6_EXG2*Cedg_Tumor_b2E6a*V_Tumor_E6a
                          + CLup_Tumor*Cedg_Tumor_b2E7
                          - CLup_Tumor*Cedg_Tumor_b2E6a)/V_Tumor_E6a;
dxdt_Cedg_Tumor_bE7b = (k_on_7_EXG*Cedg_Tumor_E7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                         - k_off_7_EXG*Cedg_Tumor_bE7b*V_Tumor_E7b
                         - k_on_7_EXG2*Cedg_Tumor_bE7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                         + k_off_7_EXG2*Cedg_Tumor_b2E7b*V_Tumor_E7b
                         + CLup_Tumor*Cedg_Tumor_bE6a
                         - CLup_Tumor*Cedg_Tumor_bE7b)/V_Tumor_E7b;
dxdt_Cedg_Tumor_b2E7b = (k_on_7_EXG2*Cedg_Tumor_bE7b*CFcRn_Tumor_E7b*V_Tumor_E7b
                          - k_off_7_EXG2*Cedg_Tumor_b2E7b*V_Tumor_E7b
                          + CLup_Tumor*Cedg_Tumor_b2E6a
                          - CLup_Tumor*Cedg_Tumor_b2E7b)/V_Tumor_E7b;
dxdt_Cedg_Tumor_bIM = (k_on_7_EXG*Cedg_Tumor_IM*CFcRn_Tumor_IM*V_Tumor_IM
                        - k_off_7_EXG*Cedg_Tumor_bIM*V_Tumor_IM
                        - k_on_7_EXG2*Cedg_Tumor_bIM*CFcRn_Tumor_IM*V_Tumor_IM
                        + k_off_7_EXG2*Cedg_Tumor_b2IM*V_Tumor_IM
                        + CLup_Tumor*(1.0-FR)*Cedg_Tumor_bE7b
                        - CLup_Tumor*(1.0-FR)*Cedg_Tumor_bIM
                        - kdeg_FcRn_Ab*Cedg_Tumor_bIM*V_Tumor_IM)/V_Tumor_IM;
dxdt_Cedg_Tumor_b2IM = (k_on_7_EXG2*Cedg_Tumor_bIM*CFcRn_Tumor_IM*V_Tumor_IM
                         - k_off_7_EXG2*Cedg_Tumor_b2IM*V_Tumor_IM
                         + CLup_Tumor*(1.0-FR)*Cedg_Tumor_b2E7b
                         - CLup_Tumor*(1.0-FR)*Cedg_Tumor_b2IM
                         - kdeg_FcRn_Ab*Cedg_Tumor_b2IM*V_Tumor_IM)/V_Tumor_IM;
dxdt_CFcRn_Tumor_VM = (CLup_Tumor*FR*CFcRn_Tumor_E7b*(1.0-FcRn_recycle_fraction)
                        - CLup_Tumor*FR*CFcRn_Tumor_VM
                        + V_Tumor_VM*(
                          - k_on_7_EXG*Cexg_Tumor_VM*CFcRn_Tumor_VM
                          + k_off_7_EXG*Cexg_Tumor_bVM
                          + kdeg_FcRn_Ab*Cexg_Tumor_bVM
                          - k_on_7_EXG2*Cexg_Tumor_bVM*CFcRn_Tumor_VM
                          + k_off_7_EXG2*Cexg_Tumor_b2VM
                          + 2.0*kdeg_FcRn_Ab*Cexg_Tumor_b2VM
                          - k_on_7_EDG*Cedg_Tumor_VM*CFcRn_Tumor_VM
                          + k_off_7_EDG*Cedg_Tumor_bVM
                          + kdeg_FcRn_Ab*Cedg_Tumor_bVM
                          - k_on_7_EDG2*Cedg_Tumor_bVM*CFcRn_Tumor_VM
                          + k_off_7_EDG2*Cedg_Tumor_b2VM
                          + 2.0*kdeg_FcRn_Ab*Cedg_Tumor_b2VM))/V_Tumor_VM;
dxdt_CFcRn_Tumor_E7 = (CLup_Tumor*FR*CFcRn_Tumor_VM+CLup_Tumor*(1.0-FR)*CFcRn_Tumor_IM
                        - CLup_Tumor*CFcRn_Tumor_E7
                        + V_Tumor_E7*(
                          - k_on_7_EXG*Cexg_Tumor_E7*CFcRn_Tumor_E7
                          + k_off_7_EXG*Cexg_Tumor_bE7
                          - k_on_7_EXG2*Cexg_Tumor_bE7*CFcRn_Tumor_E7
                          + k_off_7_EXG2*Cexg_Tumor_b2E7
                          - k_on_7_EDG*Cedg_Tumor_E7*CFcRn_Tumor_E7
                          + k_off_7_EDG*Cedg_Tumor_bE7
                          - k_on_7_EDG2*Cedg_Tumor_bE7*CFcRn_Tumor_E7
                          + k_off_7_EDG2*Cedg_Tumor_b2E7))/V_Tumor_E7;
dxdt_CFcRn_Tumor_E6a = (CLup_Tumor*CFcRn_Tumor_E7
                         - CLup_Tumor*CFcRn_Tumor_E6a
                         + CLup_Tumor*CFcRn_Tumor_E7b*FcRn_recycle_fraction
                         + V_Tumor_E6a * (
                           - k_on_6_EXG*Cexg_Tumor_E6a*CFcRn_Tumor_E6a
                           + k_off_6_EXG*Cexg_Tumor_bE6a
                           - k_on_6_EXG2*Cexg_Tumor_bE6a*CFcRn_Tumor_E6a
                           + k_off_6_EXG2*Cexg_Tumor_b2E6a
                           - k_on_6_EDG*Cedg_Tumor_E6a*CFcRn_Tumor_E6a
                           + k_off_6_EDG*Cedg_Tumor_bE6a
                           - k_on_6_EDG2*Cedg_Tumor_bE6a*CFcRn_Tumor_E6a
                           + k_off_6_EDG2*Cedg_Tumor_b2E6a))/V_Tumor_E6a;
dxdt_CFcRn_Tumor_E7b = (CLup_Tumor*CFcRn_Tumor_E6a
                         - CLup_Tumor*CFcRn_Tumor_E7b
                         + V_Tumor_E7b*(
                           - k_on_7_EXG*Cexg_Tumor_E7b*CFcRn_Tumor_E7b
                           + k_off_7_EXG*Cexg_Tumor_bE7b
                           - k_on_7_EXG2*Cexg_Tumor_bE7b*CFcRn_Tumor_E7b
                           + k_off_7_EXG2*Cexg_Tumor_b2E7b
                           - k_on_7_EDG*Cedg_Tumor_E7b*CFcRn_Tumor_E7b
                           + k_off_7_EDG*Cedg_Tumor_bE7b
                           - k_on_7_EDG2*Cedg_Tumor_bE7b*CFcRn_Tumor_E7b
                           + k_off_7_EDG2*Cedg_Tumor_b2E7b))/V_Tumor_E7b;
dxdt_CFcRn_Tumor_IM = (CLup_Tumor*(1.0-FR)*CFcRn_Tumor_E7b*(1.0-FcRn_recycle_fraction)
                        - CLup_Tumor*(1.0-FR)*CFcRn_Tumor_IM
                        + V_Tumor_IM*(
                          - k_on_7_EXG*Cexg_Tumor_IM*CFcRn_Tumor_IM
                          + k_off_7_EXG*Cexg_Tumor_bIM
                          + kdeg_FcRn_Ab*Cexg_Tumor_bIM
                          - k_on_7_EXG2*Cexg_Tumor_bIM*CFcRn_Tumor_IM
                          + k_off_7_EXG2*Cexg_Tumor_b2IM
                          + 2.0*kdeg_FcRn_Ab*Cexg_Tumor_b2IM
                          - k_on_7_EDG*Cedg_Tumor_IM*CFcRn_Tumor_IM
                          + k_off_7_EDG*Cedg_Tumor_bIM
                          + kdeg_FcRn_Ab*Cedg_Tumor_bIM
                          - k_on_7_EDG2*Cedg_Tumor_bIM*CFcRn_Tumor_IM
                          + k_off_7_EDG2*Cedg_Tumor_b2IM
                          + 2.0*kdeg_FcRn_Ab*Cedg_Tumor_b2IM))/V_Tumor_IM;
[ CAPTURE ]
EXG_ugml_Readout
Cexg_Plasma
